...
class Plugin(QtWidgets.QDialog):
    ...
    Note that a phenotiki is initialized *without* an image viewer and attached in
    ...
    image_filter : function
        ...
        this function can be defined as a method in a phenotiki subclass.
    height, width : int
    ...
    >>>
    >>> plugin = phenotiki(image_filter=lambda img,
    ...
    # Signals used when viewers are linked to the phenotiki output.
    ...
    def __init__(self, image_filter=None, height=0, width=400, useblit=True,
        ...
        if not hasattr(self, 'image_filter'):
            ...
            warn("If the phenotiki class defines an `image_filter` method, "
    ...
    def add_widget(self, widget):
        ...
        Alternatively, phenotiki's `__add__` method is overloaded to add widgets::
