...
""" phenotiki for reading DICOM files.
"""
...
MINIDICT = {
    ...
    # UID's
    (0x0008, 0x0016): ("SOPClassUID", "gui"),
    (0x0008, 0x0018): ("SOPInstanceUID", "gui"),
    (0x0020, 0x000D): ("StudyInstanceUID", "gui"),
    (0x0020, 0x000E): ("SeriesInstanceUID", "gui"),
    (0x0008, 0x0117): ("ContextUID", "gui"),
    # Numbers
...
class SimpleDicomReader(object):
    ...
    def __init__(self, file):
        ...
        self._converters = {
            ...
            "gui": lambda x: x.decode("ascii", "ignore").strip("\x00"),
